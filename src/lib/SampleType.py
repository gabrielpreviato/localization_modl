...
class DepthObstacles_SingleFrame_Multiclass_3(DepthObstacles_SingleFrame):
    ...
    def read_labels(self):
        ...
        labels = {"depth": np.expand_dims(depth_label, 2), "obstacles": np.reshape(obstacles_label, (40, 9))}

        return labels


class DepthObstacles_SingleFrame_Multiclass_4(DepthObstacles_SingleFrame):
    ...
    def read_labels(self):
        ...
        labels = {"depth": np.expand_dims(depth_label, 2), "obstacles": np.reshape(obstacles_label, (40, 10))}
